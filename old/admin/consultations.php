    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="mb-8 border-b border-gray-200">
            <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                ...
                <a href="registrations.php" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Registrations
                </a>
                <a href="consultations.php" class="border-primary text-brand-navy whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                    Consultations
                </a>
            </nav>
        </div>
